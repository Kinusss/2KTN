...
Route::name('frontend.')->group(function() {
	...
	Route::post('/gio-hang/them/{tensanpham_slug}', [HomeController::class, 'getGioHang_Them'])->name('giohang.them');
...
Route::prefix('khach-hang')->name('user.')->middleware('auth')->group(function() {
	...
	Route::post('/san-pham/{tensanpham_slug}/danh-gia', [KhachHangController::class, 'postDanhGiaSanPham'])->name('danhgiasanpham');
});
